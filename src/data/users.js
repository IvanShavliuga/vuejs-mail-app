...
export default [{ 
    ...
    ]},
    {
        ...
        content: `
            ...
            <p>country: Belarus</p>
            <p>city: Novopolotsk</p>
            <p>skills: html, css, JavaScript (EcmaScript 2016),  Vue.js, Vuex, VueRouter</p>
            <p>protfolio: <a href='https://github.com/IvanShavliuga'>github.com</a></p>
            <p>site: <a href='https://isschavliuga.ucoz.net'>isschavliuga.ucoz.net</a></p>
            <p>linkedin.com: <a href='https://linkedin.com/in/иван-иванов-шавлюга-778540153'>
            https://linkedin.com/in/иван-иванов-шавлюга-778540153</a></p>
        `,
        isImportant: true,
        isDeleted: false,
        isRead: false,
        ...
        subject: 'Предлагаю реально крутую работу',
        content: `
            <p>Я предлагаю участвовать в своем проекте</p>
            <p>От вас требуется разработка некой игры, используя технологии JavaScript.</p>
            <p>Зарплата договорная.</p>
