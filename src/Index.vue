...
<div>
   <div class="jumbotron">
       <h1 class="display-4">Vue.js mail app</h1>
       <p>This multi-user application allows you to sort mail. 
       It is possible to send an unwanted message to spam. 
       And you can also put a label "important".  
       It is possible to send messages. 
       Technologies such as vue.js and vuex.</p>
